 ...
 *	classStructure.Player information
 */
public class Player {
    ...
    /**
     * Adds an item(classStructure.Property|classStructure.Station|classStructure.Utility|Card) to players assets
     * @param item one of (classStructure.Property|classStructure.Station|classStructure.Utility|Card) to be added
     */
    ...
    /**
     * Removes an item(classStructure.Property|classStructure.Station|classStructure.Utility|Card) to players assets
     * @param item one of (classStructure.Property|classStructure.Station|classStructure.Utility|Card)
     */
     ...
     * @return a list of items(classStructure.Property|classStructure.Station|classStructure.Utility|Card)
     */
